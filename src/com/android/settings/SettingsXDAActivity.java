 ...
 */
public class SettingsXDAActivity extends AlertActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String userSafetylegalUrl = "http://forum.xda-developers.com/showpost.php?p=45414703&postcount=1";
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                mAlert.setTitle(getString(R.string.settings_xdalegal_activity_title));
            }
        ...
        p.mTitle = getString(R.string.settings_xdalegal_activity_loading);
        p.mView = mWebView;
    ...
    private void showErrorAndFinish(String url) {
        if (mErrorDialog == null) {
            mErrorDialog = new AlertDialog.Builder(this)
                    .setTitle(R.string.settings_xdalegal_activity_title)
        ...
        mErrorDialog.setMessage(getResources()
                .getString(R.string.settings_xdalegal_activity_unreachable, url));
        mErrorDialog.show();
    }
